...
pub async fn create_tenant<TR, BR, CR, TxR>(
...
pub async fn get_tenant<TR, BR, CR, TxR>(
    State(state): State<Arc<AppState<TR, BR, CR, TxR>>>,
    Path(id): Path<String>,
...
pub async fn rename_tenant<TR, BR, CR, TxR>(
    State(state): State<Arc<AppState<TR, BR, CR, TxR>>>,
    Path(id): Path<String>,
...
pub async fn delete_tenant<TR, BR, CR, TxR>(
    State(state): State<Arc<AppState<TR, BR, CR, TxR>>>,
    Path(id): Path<String>,
